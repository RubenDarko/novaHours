...
Scenario: User navigates to Nova page to log hours in current week
    ...
    Then Fill out hours in form
        ...
        | Mon | Etaluma | Testing    | 1     | TSS-1234 | Example 1 |
        | Tue | Etaluma | Testing    | 2     | TSS-1235 | Example 2 |
        | Wed | Etaluma | Testing    | 3     | TSS-1236 | Example 3 |
        | Thu | Etaluma | Testing    | 4     | TSS-1237 | Example 4 |
        | Fri | Etaluma | Testing    | 5     | TSS-1238 | Example 5 |